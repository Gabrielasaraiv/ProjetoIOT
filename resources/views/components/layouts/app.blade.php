        ...
        <div class="d-flex">
            <aside class="sidebar">
                ...
                <nav class="nav flex-column px-2">
                    ...
                    <a href="{{ route('ambiente.index') }}" class="nav-link"><i class="bi bi-building"></i>
                        Ambientes</a>
                    <a href="{{ route('sensor.index') }}" class="nav-link"><i class="bi bi-phone-vibrate-fill"></i>
                        Sensores</a>
                    <a href="{{ route('registro.index') }}" class="nav-link"><i class="bi bi-collection-fill"></i>
                        Registros</a>
                    <a href="{{route('perfil')}}" class="nav-link"><i class="bi bi-people"></i> Perfil</a>
